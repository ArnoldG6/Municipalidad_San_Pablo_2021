...
CREATE TABLE IF NOT EXISTS `bd_Muni`.`T_Administrative_File` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_T_Employee_T_Role1_idx` (`Role_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_Muni`.`T_Vacations` (
  ...
  INDEX `fk_T_Vacations_T_Administrative_File2_idx` (`id_vac` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_Muni`.`T_License_CGS` (
  ...
  INDEX `fk_T_License_CGS_T_Administrative_File1_idx` (`id_CGS` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_Muni`.`T_Inhability` (
  ...
  INDEX `fk_T_Inhability_T_Administrative_File1_idx` (`id_inha` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_Muni`.`T_License_SGS` (
  ...
  INDEX `fk_T_License_SGS_T_Administrative_File1_idx` (`id_SGS` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bd_Muni`.`T_Early_Vacations` (
  ...
  INDEX `fk_T_Early_Vacations_T_Administrative_File1_idx` (`T_Administrative_File_id` ASC) VISIBLE,
