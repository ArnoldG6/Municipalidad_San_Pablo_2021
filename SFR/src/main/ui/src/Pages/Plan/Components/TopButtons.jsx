    ...
    render() {
        ...
        return (
            <Stack className="mt-4" direction="horizontal" gap={3}>
                ...
                description={description} status={this.props.status} entryDate={this.props.entryDate} riskList={this.props.riskList} show={this.state.show} closeModal={this.closeModal} 
