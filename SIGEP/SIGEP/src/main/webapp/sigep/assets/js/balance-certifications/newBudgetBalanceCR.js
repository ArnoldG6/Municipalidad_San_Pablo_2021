...
function validateForm() {
    ...
    if ((amount === '' || amount < 150001 || amount === undefined) || ((budgetItem === '' || budgetItem === undefined) && (description === '' || description === undefined))) {
        if (amount === '' || amount < 150001 || amount === undefined) {
            Swal.fire({
                confirmButtonColor: '#3085d6',
                title: '¡Error!',
                text: 'Debe ingresar un monto mayor a 150.000 colones',
                icon: 'error'
            });
            return false;
