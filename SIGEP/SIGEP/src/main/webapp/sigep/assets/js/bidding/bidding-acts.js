function retrieveAsAdmin() {
    $.ajax({
        ...
        data: {},
        dataType: 'json',
        url: 'http://localhost:8086/home/BiddingActListService',
...
function loadTableData(data) {
    var table = $('#bidding-act-list').DataTable(
            {
                "destroy": true,
                "language": {
...
//        info: false,
                ...
                columns: [
                    ...
                    {title: "Departamento", data: "beneficiary.department.description"},
                    ...
                    {title: "Acto Inicial", "render": function (data, type, row, meta) {
                            var r = row.initialAct.documentPath;
