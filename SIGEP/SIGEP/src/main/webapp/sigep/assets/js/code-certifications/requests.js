...
function mostrar(tbody, table) {
    $(tbody).on("click", "button.responder", function (e) {
        ...
        window.localStorage.setItem('ccpRequest', id);
...
function selectBudget() {
    window.location.href = '/home/sigep/code-certifications/select-budget.jsp';
}

function buildCertificate() {
    window.location.href = '/home/sigep/code-certifications/ccp-document.jsp';
}