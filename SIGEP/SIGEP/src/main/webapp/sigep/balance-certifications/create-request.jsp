...
<html>
    ...
    <body onload="retrieveUserData();">
        ...
        <main class="mt-5">
            ...
            <div class="container py-4" style=" z-index:1;">
                <div class="card shadow-lg mb-3" style="max-width: 90rem;">
                    <div class="card-header">Solicitud de Certificado de Saldo Presupuestario</div>
                    <div class="card-body">
                        <!-- Form for requesting a budget balance certificate -->
                        <form id="form" action="${pageContext.request.contextPath}/NewBudgetBalanceCertificateRequestService" name ="formularioContacto" method="post" >
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <!-- Name input -->
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" name="amount" id="amount" class="form-control" min="150000" max="15000000" placeholder="Monto" aria-label="Amount (to the nearest dollar)"">
        ...
        <script src="../assets/js/balance-certifications/newBudgetBalanceCR.js"></script>
    </body>
</html>
