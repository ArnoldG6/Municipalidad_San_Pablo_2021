...
<html>
    ...
    <body onload="retrieveAsUser();">
        ...
        <main class="mt-5">
            <h1 class="d-flex justify-content-center"><span>Actos de Licitación</span></h1>
            <div class="container d-flex justify-content-center">
                <table id="bidding-act-list" class="table table-bordered table-hover compact" style="width:100%">
                    <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Código</th>
        ...
        <form id="form-al" style="display:none;" action="${pageContext.request.contextPath}/BiddingActDocumentService" method="get" >
        ...
        <script src="../assets/js/bidding/bidding-acts.js"></script>
    </body>
</html>
