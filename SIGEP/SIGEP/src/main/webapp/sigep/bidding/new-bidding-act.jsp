...
<html>
    ...
    <body>
        ...
        <main class="mt-5">
            <main class="mt-5">
                <div class="card mx-auto mt-3 shadow-lg rounded" style="width: 40%;">
                    <p class="card-header">Acto de licitación</p>
                    <div class="card-body">
                        <form id="form" enctype="multipart/form-data" action="${pageContext.request.contextPath}/NewBiddingActService" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="ail" class="form-label">Código del acto inicial de licitación </label>
                                <input name="ail" class="form-control" list="datalistOptions" id="ail" placeholder="Ingrese el acto inicial de licitación">
                                <datalist id="datalistOptions">
                                </datalist>
                            </div>
                            <div class="mb-1 fbtn">
                                <div class="d-flex">
                                    <label for="pdf" class="me-4">Adjuntar acto de licitación + </label>
        ...
        <script src="../assets/js/bidding/new-bidding-act.js"></script>
    </body>
</html>
