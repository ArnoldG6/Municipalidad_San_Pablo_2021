        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="alert alert-danger col-12 my-3 py-2" role="alert">
                    <i class="bi bi-exclamation-triangle-fill fs-3"></i> PÁGINA DE ERROR (ROL INVÁLIDO): Por favor regrese e ingrese un rol válido
                </div>
                <div align="center">
