...
<html>
    ...
    <body>
        ...
        <main class="mt-5">
            <main class="mt-5">
                <div class="card mx-auto mt-3 shadow-lg rounded" style="width: 40%;">
                    <p class="card-header">órden de compra</p>
                    <div class="card-body">
                        <form id="form" enctype="multipart/form-data" action="${pageContext.request.contextPath}/NewPurchaseOrderService" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="al" class="form-label">Código del acto de licitación </label>
                                <input name="al" class="form-control" list="datalistOptions" id="al" placeholder="Ingrese el acto de licitación">
                                <datalist id="datalistOptions">
                                </datalist>
                            </div>
                            <div class="mb-1 fbtn">
                                <div class="d-flex">
                                    <label for="pdf" class="me-4">Adjuntar órden de compra + </label>
        ...
        <script src="../assets/js/bidding/new-purchase-order.js"></script>
    </body>
</html>
