...
<html>
    ...
    <body onload="retrieveBudgetLocksData();">
        <jsp:directive.include file="../common/header.jsp"/>
        <main class="mt-5">
            <h1 class="d-flex justify-content-center"><span>Bloqueos</span></h1>
            <div class="container d-flex justify-content-center">
                <table id="budget-locks-list" class="table table-bordered table-hover compact" style="width:100%">
                    <thead>
                        <tr>
        ...
        <script src="../assets/js/budget/budget-locks.js"></script>
    </body>
</html>
