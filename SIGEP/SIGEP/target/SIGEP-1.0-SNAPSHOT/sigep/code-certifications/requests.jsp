...
<html>
    ...
    <body onload="retrieveAsUser();">
        ...
        <main class="mt-5">
            <h1 class="d-flex justify-content-center"><span>Solicitudes Certificados de Código</span></h1>
      ...
      if(User.validateSuperAdminRol(user) || User.validateBudgetAdminRol(user)) {
        ...
        <div class="modal fade" id="contenedor-modal3" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div  class="modal-footer">
                        <form id="form-denegate" name="form-denegate" style="display:none;" action="${pageContext.request.contextPath}/DenegateSCCP" method="post">
                            <input name="reason" id="reason">
                            <input name="sccp" id="sccp">
                        </form>
        ...
        <script src="../assets/js/code-certifications/requests.js"></script>
    </body>
</html>
