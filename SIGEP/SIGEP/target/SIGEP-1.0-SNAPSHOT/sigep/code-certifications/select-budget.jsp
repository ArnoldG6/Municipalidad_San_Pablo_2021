...
<html>
    ...
    <body onload="retrieveBudgetData();">
        ...
        <main class="mt-5">
            ...
            <form id="form-select" method="post" style="display:none;" action="${pageContext.request.contextPath}/SelectSCCPBudgetItem">
        ...
        <script src="../assets/js/code-certifications/budget-select.js"></script>
    </body>
</html>
