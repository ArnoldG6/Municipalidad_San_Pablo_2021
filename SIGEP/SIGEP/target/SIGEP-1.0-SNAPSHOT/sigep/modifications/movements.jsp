...
<%
    ...
    } else if(!User.validateBudgetAdminRol(user) && !User.validateSuperAdminRol(user) && !User.validateUserRol(user)) {
...
<html>
    ...
    <body onload="retrieveMovementsData();">
        ...
        <script src="../assets/js/modifications/movements.js"></script>
    </body>
</html>
