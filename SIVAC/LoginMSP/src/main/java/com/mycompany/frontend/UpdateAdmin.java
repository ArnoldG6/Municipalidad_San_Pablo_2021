...
public class UpdateAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        admin.setDaysEarlyVacations(Integer.parseInt(request.getParameter("earlyVac")));
        admin.setTotalEarlyVacations(Integer.parseInt(request.getParameter("totalEarlyVac")));
