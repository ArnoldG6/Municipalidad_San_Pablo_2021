...
public class Service implements Serializable {
    ...
    public String getAdminFiles(String cedula) {
        ...
        if (cedula != null && !cedula.isEmpty()) {
            ...
            for (AdminFile a : admin) {
                ...
                r.append("<th style=\"width:5px;\">");
                r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"22\" style = '%s'>", "text", "cedula",
    ...
    public String getHolidays() {
        ...
        for (Holidays a : holidays) {
            ...
            r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"19\" style = '%s'>", "text", "mes",
                    "mes", searchMonth(a.getMonth()), "readonly", "background-color: transparent; outline: none; border: none; text-align: center"));
            r.append("</th>");

            r.append("<th style=\"width:5px;\">");
            r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"38\" style = '%s'>", "text", "nombre",
    ...
    public String searchUserbyId(int cedula) {
        ...
        for (AdminFile adminF : admin) {
            if (adminF.getID() == cedula) {
                ...
                r.append("<th style=\"width:5px;\">");
                r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"22\" style = '%s'>", "text", "cedula",
                        "cedula", adminF.getAreaMuni(), "readonly", "background-color: transparent; outline: none; border: none; text-align: center"));
                r.append("</th>");
                ...
                r.append(String.format("<button color='%s' type='%s' name='%s' id='%s' value='%d' "
                        + "style=\"background-color:transparent;\" onclick='%s' title=\"Editar\">",
                        "white", "submit", "numSol", "numSol", adminF.getID(), "this.form.action=\"../PassUser;\""));
                r.append(String.format("<img src='%s' width='%s'  >", "../images/update1.ico", "21px"));
                r.append("</button>");
                ...
                r.append(String.format("<button style='%s' "
                        + "onclick=this.form.action=\"FilePDF.jsp;\" title='%s' value='%d' name='%s'>",
                        "background-color:transparent;", "Ver Historial", adminF.getID(), "historial"));
                r.append(String.format("<img src='%s' width='%s'  >", "../images/historial3.ico", "21px"));
                r.append("</button>");
                r.append("</form>");
    ...
    public String getLaboralEmployee(int idEmployee) {
        StringBuilder r = new StringBuilder();
        AdminFile funcionario = this.searchFileID(idEmployee);
        for (LaboraInhability lic : funcionario.getInhability()) {
            r.append("<tr>");
            r.append("<th>");
            r.append(returnCedulaLab(lic.getNumber_Inhability()));
            r.append("</th>");
            ...
            r.append("</th>");
            r.append("<th>");
            r.append(String.format("<form action='%s' method='%s'>", "../GetProofEM", "POST"));
            r.append(String.format("<button color='%s' type='%s' name='%s' id='%s' value='%d'>",
                    "white", "submit", "numSol", "numSol", lic.getNumber_Inhability()));
            r.append(String.format("<img src='%s' width='%s'  >", "../images/lupa.ico", "21px"));
            r.append("</button>");
    ...
    public String getBossLaboral(int lab) {
        ...
        for (LaboraInhability cgs : licenses) {
            if (cgs.getNumber_Inhability() == lab) {
                r.append("<tr>");
                r.append("<td class=\"etiqueta\">Número de solicitud:&nbsp;</td>");
                r.append("<td class=\"campo\"> ");
                r.append(String.format("<input name='%s' id='%s' value='%d' readonly='%s' style='%s' />",
                        "num", "num", cgs.getNumber_Inhability(), "readonly", "background-color: transparent; outline: none; border: none;"));
                r.append("</td>");
                r.append("</tr>");

                r.append("<tr>");
                r.append("<td class=\"etiqueta\">Estado de la licencia:&nbsp;</td>");
                r.append("<td class=\"campo\"> ");
                r.append(String.format("<input type='%s' name='%s' value='%s' readonly='%s' style='%s' />",
                        "text", "status", "Aprobada", "readonly", "background-color: transparent; outline: none; border: none;"));
                r.append("</td>");
                r.append("</tr>");
                ...
                r.append("<td class=\"campo\"> ");
                r.append(String.format("<input type='%s' name='%s' value='%s' readonly='%s' style='%s' />",
                        "text", "envio", fecha, "readonly", "background-color: transparent; outline: none; border: none;"));
                r.append("</td>");
                r.append("</tr>");
    ...
    public String getEmployeeLaboral(int lab) {
        ...
        for (LaboraInhability cgs : licenses) {
            if (cgs.getNumber_Inhability() == lab) {
                ...
                r.append("<td class=\"campo\"> ");
                r.append(String.format("<input name='%s' id='%s' value='%d' style='%s' readonly='%s'/>",
                        "num", "num", cgs.getNumber_Inhability(), "background-color: transparent; outline: none; border: none;", "readonly"));
                r.append("</td>");
                r.append("</tr>");
                ...
                r.append("<td class=\"etiqueta\">Status de la licencia:&nbsp;</td>");
                r.append("<td class=\"campo\"> ");
                r.append(String.format("<input type='%s' name='%s' value='%s' style='%s' readonly='%s'/>",
                        "text", "status", "Aprobada", "background-color: transparent; outline: none; border: none;", "readonly"));
                r.append("</td>");
                r.append("</tr>");
                ...
                r.append("<td class=\"campo\"> ");
                r.append(String.format("<input type='%s' name='%s' value='%s' style='%s' readonly='%s'/>",
                        "text", "envio", fecha, "background-color: transparent; outline: none; border: none;", "readonly"));
                r.append("</td>");
                r.append("</tr>");
    ...
    public String getInfoActUser(int id) {
        ...
        for (AdminFile adm : files) {
            if (adm.getID() == id) {
                ...
                r.append("</td>");
                r.append("<td>");
                if (adm.getIsEarlyVacations() == false) {
                ...
                r.append("</td>");
                r.append("<td>");
                r.append(String.format("<input id='%s' name='%s' readonly='%s' style='%s' value='%s'>",
                        "holidays", "holidays", "readonly", "border: none; background: transparente; outline: none;", adm.getHolidays()));
                r.append("</td>");
                r.append("</tr>");
                ...
                switch (adm.getRole().getId_role()) {
                    case 1:
                        r.append(String.format("<option value='%s'>%s</option>", adm.getRole().getId_role(), getPostionName(adm.getRole().getId_role())));
                ...
                /////////////////////////////////////////////////////////////////
                r.append("<tr>");
                //r.append("<td class=\"etiqueta\">Vacaciones adelantas:");
                //r.append("</td>");
                r.append("<td>");
                r.append(String.format("<input type='%s' id='%s' name='%s' value='%s'>",
                        "hidden", "earlyVac", "earlyVac", adm.getDaysEarlyVacations()));
                r.append("</td>");
                //r.append("</tr>");

                //r.append("<tr>");
                //r.append("<td class=\"etiqueta\">Total de vacaciones adelantas:");
                //r.append("</td>");
                r.append("<td>");
                r.append(String.format("<input type='%s' id='%s' name='%s' value='%s'>",
                        "hidden", "totalEarlyVac", "totalEarlyVac", adm.getTotalEarlyVacations()));
                r.append("</td>");
                r.append("</tr>");
    ...
    public String getPostionName(int rol) {
        switch (rol) {
            case 1:
                return "Alcalde";
            case 2:
    ...
    public String disabilityProofAccess(int id) {
        ...
        if (file.getRole().getId_role() == 1 && file.getAreaMuni().equals("Tecnologia de Informacion")
            ...
            r.append(String.format("<td class=''%s><input type='%s' name='%s' "
                    ...
                    "readonly", "background-color: transparent; outline: none; border: none; text-align: left"));
            r.append("</tr>");
        }
        return r.toString();
    }
    ...
    public String licenseAccess(int id) {
        ...
        if (file.getRole().getId_role() == 4 && file.getAreaMuni().equals("Tecnologia de Informacion")
            ...
            r.append(String.format("<td class=''%s><input type='%s' name='%s' "
                    ...
                    "readonly", "background-color: transparent; outline: none; border: none; text-align: left; width: 159px;"));
            r.append("</tr>");
        }
        return r.toString();
    }
    ...
    public String responseVacation(int cedula) {
        ...
        for (AdminFile file : employees) {
            if (file.getID() == cedula) {
                ...
                r.append("<tbody>");
                for (VacationDays vac : vacations) {
                    if (vac.getStatus().equals("Aprobado") || vac.getStatus().equals("Denegado")) {
                        r.append("<tr>");
                        r.append(String.format("<th style='%s' >", "vertical-align: middle;"));
                        r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"15\" style = '%s'>",
                        ...
                        r.append(String.format("<th style='%s' >", "vertical-align: middle;"));
                        r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"15\" style = '%s'>",
                                "text", "nombre", "nombre", file.getName(), "readonly", "background-color: transparent; outline: none; border: none; "
                                + "text-align: center"));
                        r.append("</th>");
                        r.append(String.format("<th style='%s' >", "vertical-align: middle;"));
                        r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' size=\"15\" style = '%s'>",
                                "text", "apellido", "apellido", file.getLastname_1() + " " + file.getLastname_2(), "readonly",
                                "background-color: transparent; outline: none; border: none; text-align: center"));
                        r.append("</th>");
                        r.append(String.format("<th style='%s' >", "vertical-align: middle;"));
                        r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly style = '%s'>", "text",
                                "fecha", "fecha", PlusDate.plusDate(vac.getDays()), "background-color: transparent; outline: none; "
                                + "border: none; text-align: center"));
                        r.append("</th>");
                        r.append(String.format("<th style='%s' >", "vertical-align: middle;"));
                        r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly = '%s' style = '%S'>", "text", "estado",
                                "estado", vac.getStatus(), "readonly", "background-color: transparent; outline: none; border: none; text-align: center"));
                        r.append("</th>");
                        r.append("</tr");
                        r.append("<br>");
                    }
    ...
    public String getFileEmployee(int cedula) {
        ...
        if (file != null) {
            ...
            r.append("<p>");
            r.append(String.format("<label id='%s '>", "cedula"));
            r.append(String.format("<input type='%s' id='%s' name='%s' value='%d' readonly >",
                    "hidden", "ced", "ced", cedula));
            ...
            r.append(String.format("<h6>" + "%s" + "</h6>", "(posibilidad del trabajador de obtener el permiso solicitado sin que exista "
                    + "un perjuicio en su salario,  es decir, sin que exista ningún rebajo en su remuneración por el tiempo no laborado\n)"));
            ...
            r.append(String.format("<h6>" + "%s" + "</h6>", "(corresponderán a aquellos permisos que el patrono otorga al trabajador en "
                    + "los que se realiza el rebajo correspondiente del tiempo de su ausencia.\n)"));
            ...
            r.append(String.format("<h6>" + "%s" + "</h6>", "(son un derecho y una necesidad biológica de toda persona trabajadora,  "
                    + "que tiene como propósito permitir a la persona trabajadora reponer el desgaste de energías realizado\n)"));
            ...
            r.append(String.format("<h2>" + "%s" + "</h2>", "Permisos de Vacaciones Adelantadas"));
            r.append(String.format("<h6>" + "%s" + "</h6>", "(Son vacaciones que se piden en caso de algun eventualidad extrema\n)"));
            List<EarlyVacations> early = file.getEarly();
            for (EarlyVacations result : early) {
                r.append("<table  border='1' width= '100%'>");
                r.append("<tr>");
                r.append("<td text-align= 'left' width= '50%'>");
                r.append("<p>");
                r.append("<label>");
                r.append(String.format("Número Solicitud: %d", result.getEarly_ID()));
                r.append("</label>");
                r.append("</p>");
                r.append("</td>");

                r.append("<td text-align= 'left' width= '50%'>");
                r.append(String.format("Total de dias adelantados: %d", file.getTotalEarlyVacations()));
                r.append("</td>");
                r.append("</tr>");
    ...
    public String getInfoActHoliday(int id) {
        ...
        for (Holidays holiday : holidays) {
            if (holiday.getIdHolidays() == id) {
                ...
                r.append("<button type=\"reset\" class=\"boton1\"><a href=\"listHolidays.jsp\" "
    ...
    public List<Message> allMessages() {
        ...
        message = Arrays.asList(client.target("http://localhost:8083/api/messages").request(MediaType.APPLICATION_JSON)
                .get(Message[].class));
        return message;
    }
    ...
    public String datosActualizar() {
        ...
        for (Message message : messages) {
            if (message.getStatus().equals("Pendiente")) {
                r.append("<tr>");
                r.append(String.format("<form method='%s'>", "POST"));
                r.append("<th>");
                r.append(String.format("<input type='%s' id='%s' name='%s' value='%s' readonly style = '%s'>", "text",
                        "id", "id", message.getCedula(), "background-color: transparent; outline: none; border: none; text-align: center;"));
                r.append("</th>");
                r.append("<th>");
                r.append(String.format("<textarea type='%s' id='%s' name='%s' readonly='%s' rows=\"2\" cols=\"30\" style = '%s'>", "text",
                        "mensaje", "mensaje", "readonly", "background-color: transparent; outline: none; border: none; text-align: center; resize: none;"));
                r.append(message.getMessage());
                r.append("</textarea>");
                r.append("</th>");

                r.append("<th>");
                r.append("<select id = \"estado\" name = \"estado\">");
                r.append(String.format("<option>%s</option>", message.getStatus()));
                r.append(String.format("<option>%s</option>", "Revisado"));
                r.append("</select>");
                r.append("</th>");

                r.append("<th colspan=\"1\" class=\"boton\">");
                r.append(String.format("<button type=\"submit\" class=\"boton2\" id=\"boton2\" value='%s' name='%s' formaction='%s' >"
                        + "Enviar</button>", message.getID(), "listo", "../ActualizarAviso"));
                r.append("</th>");
                r.append("</form>");
                r.append("</tr");
                r.append("</br>");
    ...
    public void updateMessage(Message message) {
        ResteasyWebTarget target = client.target("http://localhost:8083/api/messages");
        Message ad = target.request().put(Entity.entity(message, MediaType.APPLICATION_JSON),
                Message.class);
        System.out.println(ad.toString());
    }

    public String cedulaRRHH() {
        List<AdminFile> employees = this.allFiles();
        for (AdminFile admin : employees) {
            if (admin.getAreaMuni().equals("RRHH") && admin.getRole().getId_role() == 4) {
