    ...
    <body>
        ...
        <div id="wrapper">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <header>
                    <h1>Ingresar la cédula del funcionario a consultar</h1>
                </header>
