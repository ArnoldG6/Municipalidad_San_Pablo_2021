        ...
        <div id="wrapper">
            ...
            <form class='vacation' action="../Vacation" method="POST">
                <table class="form" >
                    ...
                    <tr>
                        <td class="etiqueta">Días disponibles
                        </td>
                        <td class="campo">
                            <%out.println(service.searchFileID(Integer.
                                    parseInt(request.getSession(true).getAttribute("id").toString())).getHolidays());%>
                        </td>
                    </tr>
                    <tr>
                        <td class="etiqueta">Días adelantados
                        </td>
                        <td class="campo">
                            <%boolean permiso2 = service.searchFileID(Integer.
                                    parseInt(request.getSession(true).getAttribute("id").toString())).getIsEarlyVacations();
                                if (permiso2) {
